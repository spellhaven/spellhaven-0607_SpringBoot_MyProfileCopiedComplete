			...
			<table width = "75%" border = "0" cellspacing = "0" cellpadding = "10">
				<tr height = "500">
					<td bgcolor = "#d5d5d5" align = "center" height = "500">
						...
						<form action = "infoModifyOk" method = "post" name = "reg_frm"> <!-- 폼에 이름이 있어야 자바스크립트로 validation 가능. -->
							<tr>
								<td>
							...
							<tr>
								<td colspan = "2">
									...
									<input class = "button01" type = "button" value = "아니다. 취소 ㅋ" onclick = "location.href='index'">
								</td>
